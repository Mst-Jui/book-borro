      ...
      <Card className="max-w-[500px] w-full p-8 rounded-[2rem]">
        ...
        <Form className="flex flex-col gap-6" onSubmit={onSubmit}>
          <div className="space-y-4 w-full">
            ...
            {/* Photo URL Input */}
            <div className="flex flex-col gap-1">
              <label className="text-sm font-bold text-slate-700">Photo URL</label>
              <Input name="image" placeholder="Photo link here" />
            </div>
          ...
          <div className="flex flex-col gap-3">
            <Button type="submit" className="bg-orange-500 text-white font-bold h-12 rounded-xl">
              <Check /> Register Now
            </Button>

            <Button type="reset" variant="flat" className="font-bold rounded-xl h-12">
        ...
        {/* Social Login */}
        <Button onPress={handleGoogleLogin} variant="bordered" className="w-full h-12 font-bold rounded-xl gap-3">
        ...
        <div className="text-center mt-8">
          <p className="text-slate-500">
            ...
            <Link href="/login" className="text-orange-500 font-bold hover:underline ml-1">
              Login here
            </Link>
          </p>
        </div>
